...
ALLOW = [
    ...
    # Библиография: блок «Интервью» (решение владельца 2026-09-26: «это хорошие интервью»).
    ('/Books/index.html', '/Praises/nyradio.html', 'интервью на радио «Новая Жизнь» (2003) в блоке «Интервью» библиографии'),
    # Книги: сопроводительные тексты к изданиям (решение владельца 2026-09-26).
    ('/Books/13d.html', '/Praises/xazagpre.html', 'предисловие Г. Хазагерова к «Тринадцати дискам»'),
    ('/Books/dz.html',  '/Praises/zhukovdz.html', 'текст Б. Жукова на обложке «Другой жизни»'),
    ('/Books/vv.html', '/Images/VV_pic.html',    'иллюстрации М. А. Кима к «Вишнёвому варенью»'),
