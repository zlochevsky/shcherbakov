...
Напоминаем, что в помощь организаторам концертов на этих страницах имеется раздел, содержащий [макеты и примеры афиш](Images/afish.html).
А также у нас тут есть [разные баннеры](Images/banners.html).
