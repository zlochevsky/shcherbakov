  ...
  (function(A, w) {
    ...
    c.extend({
      ...
      uaMatch: function(a) {
        ...
        else if (/opera/.test(a)) b = { browser: "opera", version: /version/.test(a) ? /version[\/ ]([\w.]+)/ : /opera[\/ ]([\w.]+)/ };
    ...
    c.event = {
      ...
      guid: 1e8,
      proxy: c.proxy,
      special: { ready: { setup: c.bindReady, teardown: c.noop }, live: { add: function(a, b) {
        c.extend(a, b || {});
    ...
    if (!c.support.changeBubbles) {
      ...
      c.event.special.change = {
        filters: { focusout: ha2, click: function(a) {
          var b = a.target, d = b.type;
          if (d === "radio" || d === "checkbox" || b.nodeName.toLowerCase() === "select") return ha2.call(this, a);
        }, keydown: function(a) {
          var b = a.target, d = b.type;
          if (a.keyCode === 13 && b.nodeName.toLowerCase() !== "textarea" || a.keyCode === 32 && (d === "checkbox" || d === "radio") || d === "select-multiple") return ha2.call(this, a);
        }, beforeactivate: function(a) {
          a = a.target;
          a.nodeName.toLowerCase() === "input" && a.type === "radio" && c.data(a, "_change_data", Da2(a));
        } },
    ...
    (function() {
      ...
      (function() {
        var g = s.createElement("div"), h = "script" + (/* @__PURE__ */ new Date()).getTime();
    ...
    c.fn.extend({ find: function(a) {
      for (var b = this.pushStack("", "find", a), d = 0, f = 0, e = this.length; f < e; f++) {
        ...
        c.find(a, this[f], b);
        if (f > 0) {
          for (var i = d; i < b.length; i++) for (var j = 0; j < d; j++) if (b[j] === b[i]) {
            b.splice(i--, 1);
            break;
          }
        }
    ...
    c.extend({ style: function(a, b, d) {
      ...
      if (b === "width" || b === "height") {
        ...
        a.offsetWidth !== 0 ? j2() : c.swap(a, mb, j2);
    ...
    c.fn.extend({ _load: c.fn.load, load: function(a, b, d) {
      ...
      c.ajax({ url: a, type: f, dataType: "html", data: b, context: this, complete: function(i, j) {
        if (j === "success" || j === "notmodified") this.html(e ? c("<div />").append(i.responseText.replace(
          rb,
          ""
    ...
    c.extend({
      ...
      ajax: function(a) {
        ...
        if (e.data && e.processData && typeof e.data !== "string") e.data = c.param(
          e.data,
          e.traditional
        );
        if (e.dataType === "jsonp") {
        ...
        if (x) {
          ...
          try {
            if (e.data || a && a.contentType) x.setRequestHeader(
              "Content-Type",
              e.contentType
            );
            if (e.ifModified) {
    ...
    c.each({ slideDown: L("show", 1), slideUp: L("hide", 1), slideToggle: L(
      "toggle",
      1
